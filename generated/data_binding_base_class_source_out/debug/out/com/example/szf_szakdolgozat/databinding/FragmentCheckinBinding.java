...
public final class FragmentCheckinBinding implements ViewBinding {
  ...
  private FragmentCheckinBinding(@NonNull LinearLayout rootView, @NonNull EditText email,
      @NonNull ImageView imageView, @NonNull Button loginButton, @NonNull EditText password) {
  ...
  public static FragmentCheckinBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCheckinBinding((LinearLayout) rootView, email, imageView, loginButton,
          password);
    }
